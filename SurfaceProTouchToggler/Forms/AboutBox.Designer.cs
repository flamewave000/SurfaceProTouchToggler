...
namespace SurfaceProTouchToggler.Forms
{
	partial class AboutBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelProductName.Text = "Surface Pro Touch Toggle";
			...
			this.labelCompanyName.Text = "flamewave000";
			...
			this.textBoxDescription.Text = "This application is free to use and redistribute according to the GNU General Pub" +
    "lic License.";
			// 
			// okButton
			// 
